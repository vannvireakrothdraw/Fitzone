...
function Compunent6() {
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-b from-black via-gray-900 to-black text-white px-6">
      {/* Header */}
      <h2 className="text-2xl md:text-3xl font-extrabold uppercase mb-4 tracking-wide">
        BLOG & NEWS
      </h2>
      ...
      {/* No Blogs Message */}
      <div className="mt-8">
        <p className="text-2xl font-bold text-cyan-400 drop-shadow-[0_0_10px_rgba(34,211,238,0.8)] text-center">
